...
const messages = {
  pt: {
    ...
    timeLabel: 'Horário:',
    timeText: 'Encontro semanal aos domingos, a partir das 16h.',
  ...
  es: {
    ...
    timeLabel: 'Horario:',
    timeText: 'Encuentro semanal los domingos, a partir de las 16:00.',
    importantLabel: 'Importante:',
  ...
  en: {
    ...
    timeLabel: 'Time:',
    timeText: 'Weekly gathering on Sundays, starting at 4:00 PM.',
